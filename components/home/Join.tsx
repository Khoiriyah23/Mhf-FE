  ...
  return (
    <section className="flex items-center justify-center mb-20 bg-gray-100">
      <div
        ...
        className="bg-center bg-no-repeat bg-cover w-[80%] h-[70vh] rounded-xl overflow-hidden shadow-lg flex items-center justify-center bg-green-800 bg-blend-multiply"
      >
